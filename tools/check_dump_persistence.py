...
ACCUMULATED = {
    ...
    "panel-colors.json": "цвета боковой панели и таба — ЕДИНСТВЕННЫЙ их источник: "
                         "дамп снимает §-коды, в логи Minecraft таблица игроков "
                         "не попадает, в NEU и на аукционе её нет вовсе",
}
